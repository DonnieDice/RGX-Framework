...
Source: [`modules/tooltip/tooltip.lua`](https://github.com/DonnieDice/RGX-Framework/blob/main/modules/tooltip/tooltip.lua). Test it in-game via [[Testing|RGX-Hello]]'s Tooltip tab.
